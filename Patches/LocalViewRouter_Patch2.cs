...
namespace KitchenGoldfishMemory.Patches
{
    ...
    static class LocalViewRouter_Patch2
    {
        ...
        static readonly Type GENERIC_TYPE = typeof(GroupMenuPhaseView.ViewData);
        const string DESCRIPTION = "Removed Specific Broadcast error logging for GroupMenuPhaseView.ViewData"; // Logging purpose of patch
